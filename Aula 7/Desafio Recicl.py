...
print("\nSistema de Apoio para Reciclagem:")
print("Aqui estão as lixeiras correspondentes para cada material:")
...
print(" - Resíduos não recicláveis: Lixeira cinza")
...
while True:
    material = input("\nInforme o tipo de material que deseja reciclar (papel, plástico, vidro, metal, orgânico ou resíduos não recicláveis): ").strip().lower()
