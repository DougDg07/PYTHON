#Faça um program que gera 3 números aleatórios (float) entre 1 e 15 e você tem 1 tentativa para descobrir qual é o maior

import random

# "uniform" e a mesma coisa que "int", porém, usado para bibliotecas de números decimais
