...
print(f"Recomendações baseadas no tamanho do aro de {aro} polegadas:")
print(f"Tamanho do guidão: {guidao:.2f} polegadas")
print(f"Tamanho da manete: {manete:.2f} polegadas")
print(f"Tamanho do quadro: {quadro:.2f} polegadas")